...
client.login("NzQ5MjI5Mzc1ODI3ODY5NzQ2.X0o8Ow.fnoQRgGtULn41_aQoegoz5OmOyg");
...
client.on("message", message => {
  ...
  fetch(link).then(() => {
    ...
    message.reply("Done uptimed your Project now 24/7 <a:724786888698757190:750987602747850752> ");
